...
<div class="sidenav">
         <div class="login-main-text">
            ...
            <p>Please Update The Required Details</p>
	...
	<button type="button" name="back" class="btn btn-black" onclick="history.back()">Back</button><br><br><br>
	
		<form:form action="save7.html" modelAttribute="i" modelmethod="post"  >
